...
background.removal <- function(raw, filtered, outdir, project) {
  ...
  print(p1+p2)
  Seurat::DotPlot(obj.before, features = top3.before$gene[1:18]) & 
    Seurat::NoLegend() & 
  ...
  Seurat::DotPlot(obj.after, features = top3.after$gene[1:18]) & 
    Seurat::NoLegend() & 
  ...
  print(p1+p2)
  Seurat::DotPlot(obj.after, features = top3.before$gene[1:18]) & 
    Seurat::NoLegend() & 
  ...
  print(p1 + p1_2)
  Seurat::DotPlot(obj.before, features = top3.after$gene[1:18]) & 
    Seurat::NoLegend() & 
